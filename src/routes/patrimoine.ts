...
/**
 * API du dashboard patrimoine — même contrat que la v1 (Express/SQLite),
 * réimplémentée en Fastify + Prisma. Montée sous /api/patrimoine et
 * protégée par le middleware d'auth du portail.
 *
...
export const patrimoineRoutes: FastifyPluginAsync = async (app) => {
  app.get('/state', async () => {
    ...
    return { ...cfg, historique, _auth: true };
  });
